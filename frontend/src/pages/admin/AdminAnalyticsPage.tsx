            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    ...
                    {overviewError ? (
                        ...
                        >
                            Analytics are unavailable; no zero values have been
                            substituted.
                            <button
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <MetricCard
                                ...
                                value={
                                    overview.active_users_daily ?? 'Unavailable'
                                }
                                subtitle={
                                    overview.active_users_daily === null
                                        ? 'No engagement snapshot'
                                        : 'Active today'
                                }
                            />
                            <MetricCard
                                ...
                                value={
                                    overview.active_users_monthly ??
                                    'Unavailable'
                                }
                                subtitle={
                                    overview.active_users_monthly === null
                                        ? 'No engagement snapshot'
                                        : 'Active this month'
                                }
                            />
                            ...
                            <MetricCard
                                ...
                                value={
                                    overview.avg_session_duration === null
                                        ? 'Unavailable'
                                        : `${overview.avg_session_duration.toFixed(1)} min`
                                }
                                subtitle={
                                    overview.avg_session_duration === null
                                        ? 'No engagement snapshot'
                    ...
                    {contentLoading ? (
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            {content.most_popular_games && (
                                <BarChartComponent
                                    data={content.most_popular_games.map(
                                        (game) => ({
                                            name: game.game_name,
                            ...
                            {content.most_popular_creators && (
                                <BarChartComponent
                                    data={content.most_popular_creators.map(
                                        (creator) => ({
