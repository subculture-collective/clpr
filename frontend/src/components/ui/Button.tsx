...
const secondaryVariant = 'border border-border bg-surface-raised text-text-primary hover:bg-surface-hover active:bg-surface cursor-pointer';
...
const dangerVariant = 'bg-error-600 text-white hover:bg-error-700 active:bg-error-800 cursor-pointer';
const outlineVariant = 'border-2 border-primary-500 text-link hover:bg-primary-950 cursor-pointer';
