...
ALTER TABLE playlist_scripts
    ...
    CHECK (strategy IN (
        ...
        'deep_cuts', 'fresh_faces', 'one_per_creator', 'similar_vibes',
        'cross_game_hits', 'controversial', 'binge_worthy', 'rising_stars',
        'twitch_top_game', 'twitch_top_broadcaster', 'twitch_trending',
        'twitch_discovery'
    ));
